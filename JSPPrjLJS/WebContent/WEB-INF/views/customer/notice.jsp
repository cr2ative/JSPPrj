...
<table class="article-list margin-small">
   ...
   <c:forEach var="n" items="${list}">
      <tr>
         <th class="seq">${n.code}</th>
         <th class="title"><a href="noticeDetail?c=${n.code}">${n.title}</a></th>
         <th class="writer">${n.writer}</th>
         <th class="regdate"><fmt:formatDate pattern="yyyy-MM-dd" value="${n.regDate}"/></th>
         <th class="hit">조회수</th>
      </tr>
	</c:forEach>
...
<div id="pager-wrapper" class="margin-small">
	<div class="pager clear">
		<p id="btnPrev">
			<a class="button btn-prev" href="notice">이전</a>
		</p>
	<ul>
